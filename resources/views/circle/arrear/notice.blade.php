...
<body>
	...
	<div>
		<p style="float: left; width: 70%">নথি নং: {{ $Helper::en2bn($stock->tin) }}/</p>
		<p style="float: right; width: 30%; text-align: right;">তারিখ: {{ $Helper::en2bn(date('d-m-Y', strtotime($data->issue_date))) }} খ্রি.</p>
	</div>
	...
	<div style="margin-top: 0.2in">
		<table style="margin: 0 auto">
			...
			<tr>				
				<td>
				    {{ $Helper::en2bn($Helper::assessment_year_format($arrear->assessment_year)) }}
				</td>
				<td>{{ $Helper::en2bn($Helper::moneyFormatBD( $a - $c )) }}</td>
				<td>{{ $Helper::en2bn($Helper::moneyFormatBD($f)) }}</td>
				<td>
				    {{ $Helper::en2bn($Helper::moneyFormatBD( $af - $c )) }}
				</td>
			</tr>
			@endforeach
	...
	<p style="text-indent: 0.5in; margin-top: 0.2in; text-align: justify;">
		উপর্যুক্ত বকেয়া আয়কর ও জরিমানা আগামী {{ $Helper::en2bn(date('d-m-Y', strtotime($data->hearing_date))) }} খ্রি. এর পূর্বে পরিশোধের অনুরোধ জানাচ্ছি । যদি ইতোমধ্যে বকেয়া কর পরিশোধ করা হয়ে থাকে তাহলে ট্রেজারী চালানের অথবা পে-অর্ডারের অনুলিপি নিম্নস্বাক্ষরকারীরর কার্যালয়ে দাখিল করার জন্য আপনাকে অনুরোধ করা হলো ।
	</p>
