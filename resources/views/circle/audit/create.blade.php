...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <form action="{{ route('circle.audit.store') }}" method="POST">
            @csrf
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="audit_date" name="audit_date" value="{{ old('audit_date') }}" autocomplete="off" placeholder="01-07-2024" required>
                            @error('audit_date')
                                <div class="text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
